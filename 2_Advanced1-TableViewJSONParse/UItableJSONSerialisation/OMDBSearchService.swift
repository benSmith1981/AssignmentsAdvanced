...
//            OMDBConstants.baseUrls.omdbPath + OMDBConstants.parameters.imdbID + "=" + imdbID + "&" + OMDBConstants.parameters.plot + "=" + plot.description +  "&" + OMDBConstants.parameters.responseDataType + "=" + response.description + "&" + OMDBConstants.parameters.tomatoes + "=true"
